...
output_file	<- "data/target_similarity/descriptor_all_select_features_mc_0.85";     # output file 
...
pair_target_func_sim <- compute.targets.function.similarity(pair_target1, pair_target2, all_targets, reactome_annotation_df, 10, 100);
...
pair_target_func_sim <- compute.targets.function.similarity(pair_target1, pair_target2, all_targets, go_annotation_df, 10, 100);
