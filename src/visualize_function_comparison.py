...
## 0. Input arguments
sim_file	= 'data/function_similarity/descriptor_all_select_features_mc_0.85_function_similarity_group.tsv'
plot_file	= 'plot/function_similarity/descriptor_all_select_features_mc_0.85_function_similarity_group_boxplot.pdf'
